...
test_loader = DataLoader(testset, batch_size, shuffle = False, drop_last = True)
model.to(device)
...
def train():
	...
	for epoch in range(n_epochs):
		...
		#_, predictions = torch.max(preds, dim = 1)
		    ...
		    if (i + 1) % 25 == 0:
		        print('Epoch [{}/{}], Step [{}/{}], Loss: {:.4f}, Accuracy: {} / {}'.format(epoch + 1, n_epochs, i + 1, total_step, loss.item(), correct, total))
